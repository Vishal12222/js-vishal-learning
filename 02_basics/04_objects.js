...
// const {courseInstructor} = course (if you think courseInstructor is big name then we use | courseInstructor: instructor) // Vishal
const {courseInstructor: instructor} = course // Vishal
